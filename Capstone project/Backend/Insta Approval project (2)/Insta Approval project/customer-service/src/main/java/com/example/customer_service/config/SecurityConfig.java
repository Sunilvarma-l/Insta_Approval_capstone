...
import com.example.customer_service.security.JwtRequestFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            .cors()  // Enable CORS handling with WebMvcConfig
            .and()
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/customers/**").authenticated()  // Secure customer endpoints
